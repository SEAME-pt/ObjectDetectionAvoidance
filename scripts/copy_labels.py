...
def copy_files_with_class_ids(txt_dir, img_dir, output_dir, target_class_ids=[5, 6, 7]):
    ...
    for txt_file in txt_files:
        ...
        if has_target_class:
            # Copy txt file
            shutil.move(txt_path, os.path.join(output_dir, 'labels', txt_file))
            ...
            for ext in ['.jpg', '.jpeg', '.png']:
                ...
                if os.path.exists(img_path):
                    shutil.move(img_path, os.path.join(output_dir, 'images', img_file))
...
# Example usage
txt_dir = '../second_training/valtxt'  # Directory with txt files
img_dir = '../second_training/val'   # Directory with images
# shutil.rmtree('../filtered/', ignore_errors=True)  # Clear previous output
output_dir = '../lights/val'  # Output directory
