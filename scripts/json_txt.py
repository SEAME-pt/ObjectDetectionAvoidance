...
# coco_json_path = '../dataset/seam/train/_annotations.coco.json'
# image_dir = '../dataset/seam/train/'
# output_mask_dir = '../dataset/seam/new_masks/train'

# generate_filled_masks(coco_json_path, image_dir, output_mask_dir, target_category_id=1)

coco_json_path = '../dataset/seam/test/_annotations.coco.json'
image_dir = '../dataset/seam/test/'
output_mask_dir = '../dataset/seam/new_masks/test'
