...
def resize_image_with_letterbox(img_path, output_path, target_size=(640, 640)):
    """
    Resize an image to target_size with letterboxing to preserve aspect ratio.
    """
    ...
    h, w = img.shape[:2]
    scale = min(target_size[0] / w, target_size[1] / h)  # Scale to fit within 640x640
...
def resize_images_in_directory(input_dir, output_dir, target_size=(640, 640)):
    """
